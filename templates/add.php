...
?>
<form class="form form--add-lot container <?= $classname_invalid ?>" action="add.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="form__container-two">
        ...
        ?>
        <div class="form__item <?= $classname_invalid ?>">
    ...
    ?>
    <div class="form__item form__item--wide <?= $classname_invalid ?>">
    ...
    ?>
    <div class="form__item form__item--file <?= $classname_invalid ?> <?= $classname_uploaded ?>">
        <!-- form__item--uploaded -->
    ...
    <div class="form__container-three">
        ...
        ?>
        <div class="form__item form__item--small <?= $classname_invalid ?>">
